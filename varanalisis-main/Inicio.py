...
st.header("Esta aplicación permite ver el historial y :red[analizar datos] de sensores recolectados en todas las :yellow[luces] que has conectado a :blue[tu cuenta].", divider="yellow")
