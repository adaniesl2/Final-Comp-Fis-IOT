...
st.header("Esta aplicación permite ver el historial y analizar datos de sensores recolectados en todas las :yellow[luces] que has conectado a tu cuenta.", divider="yellow")
st.markdown("""
